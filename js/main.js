...
app.config(function($routeProvider) {
  ...
  $routeProvider.when('/intro1',        {templateUrl: 'pages/launch1.html', reloadOnSearch: false});
  $routeProvider.when('/intro2',        {templateUrl: 'pages/launch2.html', reloadOnSearch: false});
...
app.controller('MainController', function($rootScope, $scope, $location, $q){
